...
class GoodsFactoryTest {
  ...
  void should_create_goods_successful() {
    ...
    Goods goods = goodsFactory.create("001", "name", BigDecimal.valueOf(3.5));
  ...
  void should_failed_create_goods_when_code_exists() {
    ...
    assertThrows(GoodsCodeDuplicatedException.class, () -> goodsFactory.create("001", "name", BigDecimal.valueOf(3.5)));
  }
}
